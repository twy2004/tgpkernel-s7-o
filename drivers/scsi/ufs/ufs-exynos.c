...
static int exynos_ufs_link_startup_notify(struct ufs_hba *hba, enum ufs_notify_change_status status)
{
	struct exynos_ufs *ufs = to_exynos_ufs(hba);
	int ret = 0;
...
static int exynos_ufs_pwr_change_notify(struct ufs_hba *hba, enum ufs_notify_change_status status,
					struct ufs_pa_layer_attr *pwr_max,
					struct ufs_pa_layer_attr *pwr_req)
{
	int ret = 0;
...
static void exynos_ufs_clock_control_notify(struct ufs_hba *hba, bool on, enum ufs_notify_change_status status)
{
	struct exynos_ufs *ufs = to_exynos_ufs(hba);
